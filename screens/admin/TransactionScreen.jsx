        ...
        const html = `
            ...
            <body">
                ...
                <div style="padding: 1.5rem;    ">
                    ...
                    <p>Quantity Purchased: ${products[item].quantity} pcs.</p>
                    <p>Product Information:</p>
                    <p>Name: ${products[item].product.name}</p>
                    <p>Description: ${products[item].product.description}</p>
                    <p>Price: ${products[item].product.price} / Kilo</p>
                    <br />
                    <p>Farmer Information:</p>
                    <p>Name: ${products[item].farmer.name}</p>
                    <p>Name: ${products[item].farmer.email}</p>
                    <p>Name: ${products[item].farmer.address}</p>
                    <hr />
                <div>
                `)}
            </body>
